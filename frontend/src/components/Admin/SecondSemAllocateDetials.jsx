...
function SecondSemAllocateDetials({ teacherAllocated, fetchAllocatedTeacher }) {
  ...
  const handleEdit = (id, teacher) => {
    ...
    const teacherNames = allocatedSubject.scores.map((score) => score.teacher);
  ...
  const firstSemAllocated = teacherAllocated.filter(
    (allocated) => allocated.semester === "2nd Sem"
  );
  ...
  return (
    <>
      <div className="details" style={{height:"100%"}}>
        ...
        >
          2nd Semester Allocated Teacher
        </h4>
                    ...
                    {editedAllocatedId === allocated._id ? (
                      ...
                      <>
                        <MdEdit
                          ...
                          onClick={() =>
                            handleEdit(allocated._id, allocated.teacher)
                          }
                        />
                        <MdDelete
                          style={{
...
export default SecondSemAllocateDetials;
